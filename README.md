...
This repository is designed to help researchers create reproducible experiments. Inspired by the [epfml/llm-baselines](https://github.com/epfml/llm-baselines) codebase and the [тanoGPT](https://github.com/karpathy/nanoGPT) benchmark.
